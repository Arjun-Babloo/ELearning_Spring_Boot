...
public class GlobalException {
	...
	public ResponseEntity<ErrorMessage> course(CourseException ex) {
		ErrorMessage errorMessage = new ErrorMessage(ZonedDateTime.now(ZoneId.of("Asia/Kolkata")), ex.getMessage(), HttpStatus.FORBIDDEN);
		loggingClient.logMessage("ERROR", errorMessage.toString());
		return new ResponseEntity<>(
				errorMessage,
